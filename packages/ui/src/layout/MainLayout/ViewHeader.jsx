        ...
        <Box sx={{ flexGrow: 1, py: 1.25, width: '100%' }}>
            ...
            >
                <Box sx={{ display: 'flex', alignItems: 'center', flexDirection: 'row' }}>
                    {isBackButton && (
                        <StyledFab sx={{ mr: 3 }} size='small' color='secondary' aria-label={t('Back')} title={t('Back')} onClick={onBack}>
                            <IconArrowLeft />
                        </StyledFab>
                    )}
                    ...
                    {isEditButton && (
                        <IconButton sx={{ ml: 3 }} color='secondary' title={t('Edit')} onClick={onEdit}>
                            <IconEdit />
                        </IconButton>
                    )}
                </Box>
