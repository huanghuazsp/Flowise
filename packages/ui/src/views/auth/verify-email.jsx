                    ...
                    <Stack sx={{ alignItems: 'center', gap: 2 }}>
                        {loading && (
                            <>
                                ...
                                />
                                <Typography variant='h1'>{t('Verifying Email...')}</Typography>
                            </>
                        )}
                        {verificationError && (
                            <>
                                ...
                                <Typography variant='h1'>{t('Verification Failed.')}</Typography>
                            </>
                        )}
                        {verificationSuccess && (
                            <>
                                ...
                                <Typography variant='h1'>{t('Email Verified Successfully.')}</Typography>
                            </>
                        )}
                    </Stack>
                </Stack>
